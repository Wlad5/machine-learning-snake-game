...
def plot_rolling_avg_score(data):
    ...
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / 'plot_1_rolling_avg_score.png', dpi=150)
...
def plot_rolling_avg_reward(data):
    ...
    ax.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / 'plot_2_rolling_avg_reward.png', dpi=150)
...
def plot_success_rate(data):
    ...
    ax.set_ylim([0, 105])
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / 'plot_3_success_rate.png', dpi=150)
...
def plot_final_performance(data):
    ...
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / 'plot_4_final_performance.png', dpi=150)
...
def plot_training_efficiency(data):
    ...
    ax.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / 'plot_5_training_efficiency.png', dpi=150)
...
def plot_reward_distribution(data):
    ...
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / 'plot_6_reward_distribution.png', dpi=150)
...
def plot_stability_variance(data):
    ...
    ax.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig(PLOTS_DIR / 'plot_7_stability_variance.png', dpi=150)
