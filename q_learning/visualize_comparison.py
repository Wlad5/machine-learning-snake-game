...
# Configuration
ENCODINGS = {
    'basic': 'training_stats_basic.csv',
    'bodyaware': 'training_stats_bodyaware.csv',
    'distance': 'training_stats_distance.csv',
    'localgrid': 'training_stats_localgrid.csv',
    'raycasting': 'training_stats_raycasting.csv',
}
...
def plot_rolling_avg_score(data):
    ...
    plt.tight_layout()
    plt.savefig(Path(__file__).parent / 'plot_1_rolling_avg_score.png', dpi=150)
...
def plot_rolling_avg_reward(data):
    ...
    ax.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig(Path(__file__).parent / 'plot_2_rolling_avg_reward.png', dpi=150)
...
def plot_success_rate(data):
    ...
    ax.set_ylim([0, 105])
    plt.tight_layout()
    plt.savefig(Path(__file__).parent / 'plot_3_success_rate.png', dpi=150)
...
def plot_final_performance(data):
    ...
    plt.tight_layout()
    plt.savefig(Path(__file__).parent / 'plot_4_final_performance.png', dpi=150)
...
def plot_training_efficiency(data):
    ...
    ax.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig(Path(__file__).parent / 'plot_5_training_efficiency.png', dpi=150)
...
def plot_reward_distribution(data):
    ...
    plt.tight_layout()
    plt.savefig(Path(__file__).parent / 'plot_6_reward_distribution.png', dpi=150)
...
def plot_stability_variance(data):
    ...
    ax.grid(True, alpha=0.3)
    plt.tight_layout()
    plt.savefig(Path(__file__).parent / 'plot_7_stability_variance.png', dpi=150)
...
def main():
    ...
    print("  - Plot 3: Final performance summary...")
    plot_final_performance(data)
    
    # Optional plots
    print("  - Plot 4: Training efficiency...")
    plot_training_efficiency(data)
    
    print("  - Plot 5: Reward distribution...")
    plot_reward_distribution(data)
    
    print("  - Plot 6: Stability variance...")
    plot_stability_variance(data)
    
    print("\nAll plots saved and displayed!")
    plt.show()
    print("Generated files:")
    print("  - plot_1_rolling_avg_score.png")
    print("  - plot_2_success_rate.png")
    print("  - plot_3_final_performance.png")
    print("  - plot_4_training_efficiency.png")
    print("  - plot_5_reward_distribution.png")
    print("  - plot_6_stability_variance.png")
