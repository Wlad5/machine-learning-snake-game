...
# Configuration
ENCODINGS = {
    'basic': 'dqn_training_stats_basic.csv',
    'bodyaware': 'dqn_training_stats_bodyaware.csv',
    'distance': 'dqn_training_stats_distance.csv',
    'localgrid': 'dqn_training_stats_localgrid.csv',
    'raycasting': 'dqn_training_stats_raycasting.csv',
}
...
def main():
    ...
    print("  - dqn_plot_1_rolling_avg_score.png")
    print("  - dqn_plot_2_rolling_avg_reward.png")
    print("  - dqn_plot_3_success_rate.png")
    print("  - dqn_plot_4_final_performance.png")
    print("  - dqn_plot_5_training_efficiency.png")
    print("  - dqn_plot_6_reward_distribution.png")
    print("  - dqn_plot_7_stability_variance.png")
